...
Automatically fill in the pixels based on the selected font. For this to work, you have to choose a font in the [Based on](#based-on) section in the left sidebar first. Note: this will clear all existing pixels of the glyph before filling it. It will also set the [bearings](#bearings).
...
Note: some browser might not be able to use your locally installed fonts due to privacy restrictions.
